#!/usr/bin/env python3
"""Production-fidelity replay for the 15m bot.

Runs the same `BundleBacktestRunner` that drives the 5m bot's tuning, but for
the 15m chart. Compares two configs over one bundle:
...
Usage:  ./replay.py [bundle_dir]
        bundle_dir defaults to the most recent 15m bundle under polymarket/logs/15m/.
"""
...
LOGS_DIR = REPO_ROOT / "polymarket" / "logs" / "15m"
VALUES_YAML = CHART_DIR / "values.yaml"
BOT_YAML = HELM_DIR / "bots" / "pm_btc_15m_smart.yaml"
