...
## §65 (2026-09-06) "What else can we abuse?" sweep — 4 closed, 1 live candidate (late-shift, analysis only)
User asked for an abuse-scan of data on hand (5m only, no code). Sources: 21d bot logs + mrec v2 09-01..06.
1) **Mid-band 0.90-0.98 bleed lever: RESOLVED, no action.** 21d total −$124.89 (−1.36% ROI, 1010 fills) but the era split shows it: pre-08-29 −$157.42, **current era (§58 skip + §61 gap live) +$32.53 (71W-1L, +2.31%)**. The deployed changes already collected this lever. Analytics-lead closed.
2) **Ladder cap ($48) raise: REFUTED.** 82 bars reached >=$44 spent; 79 won the bar; pooled pnl **−$54.40** — the 3 full-double losses outweigh 79 penny wins. The cap is saving money. Do not raise.
