...
| **Taker in the [ws−3, ws) pre-open window on locked-strike displacement** | 🟡 OPEN SEAM — plausible, unproven (08-29) | pre-open book does NOT price the locked strike (ask ~0.54 flat vs win% rising with \|m0\|); era-correct TWAP-60 sample is only ~3 days; needs cl-truth rerun + vol-normalized z + cluster null + pre-open fill physics. ⚠️ era trap: strike recon must match the era (point <08-07 / TWAP-30 / TWAP-60 ≥08-14) | [strat-openlag](strat-openlag.md) |
