...
- [PM BTC 1h exit v3 DEPLOYED 2026-05-11](project_pm_btc_1h_exit_v3_deployed_2026_05_11.md) — commit `0c42d681`. v3-prod (full-corpus refit, CV AUC 0.760) shipped at `smartExitModelThreshold: "0.50"` (down from v1's 0.70 — more aggressive). Monitor next bundle for: (1) p_loss spread vs saturation, (2) fire rate ~40-60% (vs v1's 100% on bundle 7), (3) varied held-durations on model_exit. Rollback: `git revert 0c42d681 && ./deploy.sh pm_btc_1h_smart`. Disable: set threshold to "0".
