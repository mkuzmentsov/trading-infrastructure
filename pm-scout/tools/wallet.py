...
Reads creds from every-tick-single/chart/bots/scout.secret.yaml (gitignored live
...
SECRET_YAML = os.path.join(ROOT, "every-tick-single", "chart", "bots", "scout.secret.yaml")
