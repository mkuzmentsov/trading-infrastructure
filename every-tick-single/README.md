...
Fork of `every-tick-trader/` (2026-07-03) so single-side experiments never touch
...
Findings log + strategy rationale: see `every-tick-trader/PLAN.md` (shared history).
